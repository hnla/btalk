 ...
 * temp!
 */
function default_custom_logo() {
		return  get_template_directory_uri() . '/assets/images/logo/brighttalk-header.png';
}

function btalk_custom_logo( $blog_id = 0) {
	echo btalk_get_custom_logo();
}

function btalk_get_custom_logo( $blog_id = 0 ) {
			...
			$custom_logo_size = esc_attr('width-' . '100' );
			...
			/**
				...
				*/
			return  apply_filters( 'btalk_get_custom_logo', $html, $blog_id );
}
