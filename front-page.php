	...
	<div id="primary" class="content-area">
		...
		<?php if ( is_active_sidebar('homepage-block-1-loggedin') ) { ?>
			<div class="block-1">
				...
				<div class="btalk-channel">
					<?php echo do_shortcode('[BrightTALK channelid=1166 commid=291919 displaymode=standalone track="tracking data"]'); ?>
				</div>
		...
		<?php }; ?>
			...
			<div class="block-2">
				...
				<div class="loop-block">
					<h2 class="section-title"><?php _e('Latest Webinars', 'btalk'); ?></h2>
					<?php get_template_part('/template-parts/home-page/webinars-loop'); ?>
				</div>

				<div class="loop-block">
					<h2 class="section-title"><?php _e('Latest Posts', 'btalk'); ?></h2>
