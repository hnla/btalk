 ...
 *
 * @uses btalk_header_style()
 */
function btalk_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'btalk_custom_header_args', array(
		'default-image'          => get_template_directory_uri() . '/assets/images/default-images/default-header.jpg',
		'default-text-color'     => '000000',
		'width'                  => 1400,
		'height'                 => 350,
		'flex-height'            => false,
		'wp-head-callback'       => 'btalk_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'btalk_custom_header_setup' );

if ( ! function_exists( 'btalk_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see btalk_custom_header_setup().
	 */
	function btalk_header_style() {
